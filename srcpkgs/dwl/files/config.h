...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_comma,      viewadj,        {.i = -1} },
	{ MODKEY,                    XKB_KEY_period,     viewadj,        {.i = +1} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_less,       tagadj,         {.i = -1} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_greater,    tagadj,         {.i = +1} },
	{ MODKEY|WLR_MODIFIER_CTRL|WLR_MODIFIER_SHIFT, XKB_KEY_less,     toggletagadj, {.i = -1} },
	{ MODKEY|WLR_MODIFIER_CTRL|WLR_MODIFIER_SHIFT, XKB_KEY_greater,  toggletagadj, {.i = +1} },
	...
	{ MODKEY,                    XKB_KEY_i,          spawn,          EXEC("vol", "up") },
	{ MODKEY,                    XKB_KEY_u,          spawn,          EXEC("vol", "down") },
	{ MODKEY,                    XKB_KEY_m,          spawn,          EXEC("vol", "mute") },
	{ MODKEY,                    XKB_KEY_i,          spawn,          EXEC("bri", "up") },
	{ MODKEY,                    XKB_KEY_u,          spawn,          EXEC("bri", "down") },
	{ MODKEY,                    XF86XK_PowerOff,    spawn,          EXEC("sysact") },
	{ 0,                         XF86XK_PowerOff,    spawn,          EXEC("xset", "dpms", "force", "off") },
	/* { MODKEY,                    XKB_KEY_Escape,     spawn,          EXEC("slock") }, */
	{ MODKEY,                    XKB_KEY_a,          spawn,          EXEC("appmenu") },
	{ MODKEY,                    XKB_KEY_s,          spawn,          EXEC("ddic") },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_W,          spawn,          EXEC("web") },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_W,          view,           {.ui = 1 << 8 } },
	{ MODKEY,                    XKB_KEY_g,          spawn,          EXEC("dgen") },
...
adjtag(const Arg * arg)
{
	...
	if (arg->i > 0)
		return seltag == (1 << (TAGCOUNT - 1)) ? 1 : seltag << 1;
	else
		return seltag == 1 ? (1 << (TAGCOUNT - 1)) : seltag >> 1;
}
